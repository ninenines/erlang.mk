...
| hex            | hex vsn [pkg]   | Download the given project version from hex.pm
...
If the package name in hex.pm doesn't match the name of your app,
you can specify a second parameter with the package name:

[source,make]
dep_jiffy = hex 0.14.5 barrel_jiffy
