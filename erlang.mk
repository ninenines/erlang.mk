...
build-plt: deps app
	@DIALYZER_PLT=$(DIALYZER_PLT) dialyzer --build_plt --apps erts kernel stdlib $(PLT_APPS) $(ALL_DEPS_DIRS)

dialyze:
	@DIALYZER_PLT=$(DIALYZER_PLT) dialyzer --src src --no_native $(DIALYZER_OPTS)
